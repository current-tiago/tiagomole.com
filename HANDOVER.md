...
2. **Six Poems** (`#poems`, labelled "Six Little Love Letters") — redesigned June 2026 from an accordion into a 3-col grid of **openable love-letter envelopes** (kraft envelope + lifting flap + wax heart seal "T♥I" + roman-numeral postage stamp). Click/Enter toggles `.open` on the `.envelope` (`toggleEnvelope` / `envelopeKey` in JS) — flap lifts, seal fades, and the poem unfolds below on lined notebook paper with a handwritten sign-off. Each opens independently (no longer one-at-a-time). Verse text unchanged; `.poem-stanzas` / `.stanza p` classes retained.
   - I · Sample no.1 · II · View of the Room · III · T-3 Weeks · IV · Studying · V · Orpheus · VI · Summer Afternoon
